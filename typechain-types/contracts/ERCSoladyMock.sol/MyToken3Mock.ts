...
export interface MyToken3MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "_name"
...
export interface MyToken3Mock extends BaseContract {
  connect(runner?: ContractRunner | null): MyToken3Mock;
  waitForDeployment(): Promise<this>;

  interface: MyToken3MockInterface;
