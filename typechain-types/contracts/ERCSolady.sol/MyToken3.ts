...
export interface MyToken3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "_name"
...
export interface MyToken3 extends BaseContract {
  connect(runner?: ContractRunner | null): MyToken3;
  waitForDeployment(): Promise<this>;

  interface: MyToken3Interface;
